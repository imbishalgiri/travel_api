...
# ---------------------------- utility functions (endpoint --> /treks)
def add_treks():
...
# Utility function to get all the treks
def get_treks():
    if get_all_treks():
        single_trek = []
...
# ---------------------- end of utility functions (endpoint --> /treks)

# --------------------------------- CONTROLLERS DOWN HERE

@token_required
# for both adding and getting treks
# supported requests --> @GET/trek @POST/trek
